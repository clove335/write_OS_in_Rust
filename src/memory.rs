...
// It was pub fn but made it private
...
// Translates the given virtual address to the mapped physical address, or 'None'
//
// This function is unsafe because the caller must gurantee
// that the complete physical memory is mapped to virtual memory
// at the 'physical_memory_offset'
//pub unsafe fn translate_addr(addr: VirtAddr, physical_memory_offset: VirtAddr) -> Option<PhysAddr> {
//    translate_addr_inner(addr, physical_memory_offset)
//}

// Private function for translate_addr
...
// This function is unsafe because the caller must gurantee that
// the complete physical memory is mapped to virtual memory
...
pub fn create_example_mapping(
    ...
    let map_to_result = unsafe {
        // TODO: this is not safe, we do it only for test
